...
class RelationshipBarDocument {
  ...
  static RelationshipBarDocument fromMap(Map<String, Object?> res) {
    ...
    return RelationshipBarDocument(
      ...
      barList: RelationshipBar.fromMapList(res[columnBarList] as List<dynamic>),
    );
  }
  ...
  Future<void> firestoreSet(String userID) async {
    ...
    return await userBarsFirestoreRef(userID)
        ...
        .catchError((error) => print("firestoreSet: Failed to add relationship bar document: $error"));
  }
  ...
  static Future<void> firestoreSetList(String userID, List<RelationshipBarDocument> barDocs) async {
    ...
    final CollectionReference<RelationshipBarDocument> ref = userBarsFirestoreRef(userID);
  ...
  static Future<void> firestoreUpdateColumns(String userID, String barDocID, Map<String, dynamic> data) async {
    print("firestoreUpdateColumns: $barDocID");
    await userBarsFirestoreRef(userID)
        .doc(barDocID)
        .update(data)
        .then((value) => print("Relationship Bar Document Update"))
        .catchError((error) => print("firestoreUpdateColumns: Failed to update relationship bar document: $error"));
  }
  ...
  Future<void> firestoreDelete(String userID) async {
    ...
    await userBarsFirestoreRef(userID)
        ...
        .catchError((error) => print("firestoreDelete: Failed to delete relationship bar document: $error"));
  }
