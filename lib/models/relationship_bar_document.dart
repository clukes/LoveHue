...
class RelationshipBarDocument {
  ...
  Future<void> resetBars() async {
    ...
    if (prevBarDoc == null) {
      debugPrint(
          "RelationshipBarDocument.resetBars: Retrieved no bars from firestore.");
      return;
    }
  ...
  static CollectionReference<RelationshipBarDocument> getUserBarsFromID(
    ...
    return firestore
        ...
        .withConverter<RelationshipBarDocument>(
          fromFirestore: (snapshots, _) => RelationshipBarDocument.fromMap(
              snapshots.data()!, userID, firestore),
  ...
  static RelationshipBarDocument fromMap(
      Map<String, Object?> res, String userID, FirebaseFirestore? firestore) {
    return RelationshipBarDocument(
      ...
      barList: res[columnBarList] != null
          ? RelationshipBar.fromMapList(
              List<Map<String, Object?>>.from(res[columnBarList] as List))
          : null,
      firestore: firestore,
      userID: userID,
    );
  ...
  Future<RelationshipBarDocument?> firestoreGet([GetOptions? options]) async {
    debugPrint(
        "RelationshipBarDocument.firestoreGet: Get doc with barDocID: $id.");
  ...
  static Future<RelationshipBarDocument?> firestoreGetLatest(
      String userID, FirebaseFirestore? firestore,
      [GetOptions? options]) async {
    debugPrint(
        "RelationshipBarDocument.firestoreGetLatest: Get doc for userID: $userID.");
    ...
    return await getUserBarsFromID(userID, firestore)
        ...
        .limit(1)
        .get(options)
        .then((QuerySnapshot<RelationshipBarDocument?> snapshot) =>
  ...
  static Query<RelationshipBarDocument> getOrderedUserBarsFromID(
      String userID, FirebaseFirestore? firestore) {
    return getUserBarsFromID(userID, firestore)
  ...
  static Future<List<RelationshipBarDocument?>> firestoreGetAll(
      String userID, FirebaseFirestore? firestore,
      [GetOptions? options]) async {
    debugPrint(
        "RelationshipBarDocument.firestoreGetAll: Get docs for userID: $userID.");
    return await getUserBarsFromID(userID, firestore)
        .get(options)
        .then((snapshot) => fromQuerySnapshot(snapshot))
        .catchError((error) {
      debugPrint(
          "RelationshipBarDocument.firestoreGetAll: Failed to retrieve relationship bar documents: $error.");
      return <RelationshipBarDocument>[];
    });
  }
  ...
  Future<void> firestoreSet() async {
    debugPrint(
        "RelationshipBarDocument.firestoreSet: Set doc with id: $id, for userID: $userID.");
    return await getUserBarsFromID(userID, firestore)
        .doc(id)
        ...
        .catchError((error) => debugPrint(
            "RelationshipBarDocument.firestoreSet: Failed to add relationship bar document: $error"));
  }
  ...
  Future<void> firestoreUpdateColumns(Map<String, Object?> data) async {
    debugPrint(
        "RelationshipBarDocument.firestoreUpdateColumns: Update doc with id: $id.");
    await getUserBarsFromID(userID, firestore)
        .doc(id)
        .update(data)
        .then((value) => debugPrint(
            "RelationshipBarDocument.firestoreUpdateColumns: Relationship Bar Document Updated."))
        .catchError((error) => debugPrint(
  ...
  Future<void> firestoreDelete() async {
    debugPrint(
        "RelationshipBarDocument.firestoreDelete: Delete doc with id: $id.");
    await getUserBarsFromID(userID, firestore)
        .doc(id)
        .delete()
        .then((value) => debugPrint(
            "RelationshipBarDocument.firestoreDelete: Relationship Bar Document Deleted."))
        .catchError((error) => debugPrint(
            "firestoreDelete: Failed to delete relationship bar document: $error."));
  }
  ...
  static RelationshipBarDocument firestoreAddBarListWithBatch(
    ...
    debugPrint(
        "RelationshipBarDocument.firestoreAddBarListWithBatch: Add list: $barList.");
    final CollectionReference<RelationshipBarDocument> ref =
        getUserBarsFromID(userID, firestore);
