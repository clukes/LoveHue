...
class RelationshipBarDocument {
  ...
  static CollectionReference<RelationshipBarDocument> getUserBarsFromID(String userID, FirebaseFirestore? firestore) {
    ...
    return firestore.collection(userBarsCollection).doc(userID).collection(specificUserBarsCollection).withConverter<RelationshipBarDocument>(
  ...
  Future<RelationshipBarDocument?> firestoreGet([GetOptions? options]) async {
    ...
    RelationshipBarDocument? doc =
        await getUserBarsFromID(userID, firestore).doc(id).get(options).then((snapshot) => snapshot.data()).catchError((error) {
  ...
  static Future<RelationshipBarDocument?> firestoreGetLatest(String userID, FirebaseFirestore? firestore, [GetOptions? options]) async {
  ...
  static Future<List<RelationshipBarDocument?>> firestoreGetAll(String userID, FirebaseFirestore? firestore, [GetOptions? options]) async {
    debugPrint("RelationshipBarDocument.firestoreGetAll: Get docs for userID: $userID.");
    return await getUserBarsFromID(userID, firestore).get(options).then((snapshot) => fromQuerySnapshot(snapshot)).catchError((error) {
  ...
  Future<void> firestoreSet() async {
    ...
    return await getUserBarsFromID(userID, firestore)
        ...
        .then((value) => debugPrint("RelationshipBarDocument.firestoreSet: Relationship Bar Document Added with id: $id, for userID: $userID."))
        .catchError((error) => debugPrint("RelationshipBarDocument.firestoreSet: Failed to add relationship bar document: $error"));
  }
  ...
  static Future<void> firestoreSetList(String userID, List<RelationshipBarDocument> barDocs, FirebaseFirestore firestore) async {
  ...
  Future<void> firestoreUpdateColumns(Map<String, Object?> data) async {
    ...
    await getUserBarsFromID(userID, firestore)
        .doc(id)
        .update(data)
        .then((value) => debugPrint("RelationshipBarDocument.firestoreUpdateColumns: Relationship Bar Document Updated."))
        .catchError((error) => debugPrint("RelationshipBarDocument.firestoreUpdateColumns: Failed to update relationship bar document: $error."));
  }
  ...
  static Future<RelationshipBarDocument?> firestoreAddBarList(String userID, List<RelationshipBar>? barList, FirebaseFirestore firestore) async {
